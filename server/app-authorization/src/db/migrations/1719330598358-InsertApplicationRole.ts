...
export class InsertApplicationRole1719330598358 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO \`sec_roles\` (\`focus_id\`,\`name\`,\`sec_role_id\`) VALUES (${RolesFocusEnum.APPLICATION}, 'General Admin',${RolesEnum.SYSTEM_ADMIN}), (${RolesFocusEnum.APPLICATION}, 'IT Support', ${RolesEnum.IT_SUPPORT}), (${RolesFocusEnum.APPLICATION}, 'Contributor', ${RolesEnum.CONTRIBUTOR}), (${RolesFocusEnum.APPLICATION}, 'Global', ${RolesEnum.GLOBAL})`,
    );
  }
